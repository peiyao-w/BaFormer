...
class SetCriterion_cat_bd(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_masks):
        ...
        loss_ce = sigmoid_focal_loss(src_logits.squeeze(dim=-1), target_classes.float(), num_masks, alpha=0.25, gamma=2) # use binary cross_entropy for the 1-0 classification
